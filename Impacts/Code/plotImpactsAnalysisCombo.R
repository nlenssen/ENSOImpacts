...
plotTitle <- sprintf('Probability of Precipitation Anomaly (%s, %s)', ellaName[el], seasonNameFull[seasonInds[s]])
...
pdf(sprintf('%s/empiricalProbsCombo/%sProb.pdf',plotdir,plotName),10,6)
...
paperdir <- '/Users/lenssen/Dropbox/DEES/LisaWork/ensoPaper/Revision02/Revision2'
system(sprintf('cp %s/empiricalProbsCombo/01NinoDJFProb.pdf %s/03a_NinoDJFProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/01NinaDJFProb.pdf %s/03b_NinaDJFProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/04NinoMAMProb.pdf %s/03a_NinoMAMProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/04NinaMAMProb.pdf %s/03b_NinaMAMProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/07NinoJJAProb.pdf %s/03a_NinoJJAProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/07NinaJJAProb.pdf %s/03b_NinaJJAProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/10NinoSONProb.pdf %s/03a_NinoSONProb.pdf',plotdir, paperdir))
system(sprintf('cp %s/empiricalProbsCombo/10NinaSONProb.pdf %s/03b_NinaSONProb.pdf',plotdir, paperdir))